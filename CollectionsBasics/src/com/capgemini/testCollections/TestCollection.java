//Test class for creating ArrayList of instances of collectionClasses and printing them
// Duplicates are accepted in ArrayLists
package com.capgemini.testCollections;

import java.util.ArrayList;
import java.util.List;

import com.capgemini.collectionClasses.Car;
import com.capgemini.collectionClasses.CellPhone;
import com.capgemini.collectionClasses.Laptop;
import com.capgemini.collectionClasses.School;
import com.capgemini.collectionClasses.Television;
...
public class TestCollection {
	...
	public static void main(String args[]) {
		...
		// duplicate entry( same company and model) : NOT Rejected by ArrayList
