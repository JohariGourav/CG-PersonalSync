	...
	public static void main(String[] args) {
		...
		for(i=0;i<3;i++) {
			...
			if(largeDensity < country[i].getDensity()) {
				...
				denCounter++;
				//System.out.println(denCounter);
			}
		}
		
		System.out.println("The country with largest population is "+country[popCounter-1].getCountryName()+" with population "+country[popCounter-1].getPopulation());
		System.out.println("The country with largest area is "+country[areaCounter-1].getCountryName()+" with area "+country[areaCounter-1].getArea());
		System.out.println("The country with largest density is "+country[denCounter-1].getCountryName()+" with density "+country[denCounter-1].density);
