...
public class TestTriangle {
	...
	public static void main(String[] args) {
		...
		switch(ch) {
		case 1: if(triangle.isRight(triangle.getSide1(), triangle.getSide2(), triangle.getSide3()))
					System.out.println("Its a Right Triangle");
				else
					System.out.println("Its not a right triangle");
				break;
		case 2: if(triangle.isScalene(triangle.getSide1(), triangle.getSide2(), triangle.getSide3()))
					System.out.println("Its a Scalene Triangle");
				else
					System.out.println("Its not a Scalene triangle");
				break;
		case 3: if(triangle.isIsosceles(triangle.getSide1(), triangle.getSide2(), triangle.getSide3()))
					System.out.println("Its a isosceles Triangle");
				else
					System.out.println("Its not a isosceles triangle");
				break;
		case 4: if(triangle.isEquilateral(triangle.getSide1(), triangle.getSide2(), triangle.getSide3()))
